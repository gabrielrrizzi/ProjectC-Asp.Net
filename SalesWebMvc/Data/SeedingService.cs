    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            else
            {
                ...
                Seller s2 = new Seller(2, "Gabriel Rizzi", "g@gmail.com", new DateTime(2002, 4, 14), 5000.0, d2);
                Seller s3 = new Seller(3, "Lorena ", "l@gmail.com", new DateTime(2003, 4, 24), 10000.0, d3);
                Seller s4 = new Seller(4, "Lucas", "lc@gmail.com", new DateTime(1994, 2, 12), 110000.0, d4);
                ...
                SalesRecord r14 = new SalesRecord(14, new DateTime(2018, 09, 4), 3000.0, SaleStatus.Billed, s4);
                ...
                SalesRecord r19 = new SalesRecord(19, new DateTime(2018, 10, 22), 8000.0, SaleStatus.Billed, s2);
                SalesRecord r20 = new SalesRecord(20, new DateTime(2018, 10, 15), 8000.0, SaleStatus.Billed, s1);
